 ...
 * @icon fa fa-circle-o
 */
class ProxyUserMoneyLogV1 extends Backend
{
    
    /**
     * ProxyUserMoneyLogV1模型对象
     * @var \app\common\model\ProxyUserMoneyLogV1
     */
    ...
    {
        parent::_initialize();
        $this->model = new \app\common\model\ProxyUserMoneyLogV1;
