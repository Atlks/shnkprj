define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'app_whitelist/index' + location.search,
                    add_url: 'app_whitelist/add',
                    edit_url: 'app_whitelist/edit',
                    del_url: 'app_whitelist/del',
                    multi_url: 'app_whitelist/multi',
                    import_url: 'app_whitelist/import',
                    table: 'app_whitelist',
                }
            });
