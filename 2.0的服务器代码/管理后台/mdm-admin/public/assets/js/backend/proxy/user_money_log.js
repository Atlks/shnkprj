define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'proxy/user_money_log/index' + location.search,
                    // add_url: 'proxy/user_money_log/add',
                    edit_url: 'proxy/user_money_log/edit',
                    // del_url: 'proxy/user_money_log/del',
                    // multi_url: 'proxy/user_money_log/multi',
                    import_url: 'proxy/user_money_log/import',
                    table: 'proxy_user_money_log',
                }
            });
