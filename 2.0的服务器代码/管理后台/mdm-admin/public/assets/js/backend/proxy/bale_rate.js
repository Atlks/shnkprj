define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'proxy/bale_rate/index' + location.search,
                    // add_url: 'proxy/bale_rate/add',
                    // edit_url: 'proxy/bale_rate/edit',
                    // del_url: 'proxy/bale_rate/del',
                    // multi_url: 'proxy/bale_rate/multi',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'proxy_app.name', title: __('APP'),formatter:Table.api.formatter.search},
                        {field: 'pid', title: __('Pid'),formatter:Table.api.formatter.search},
                        {field: 'proxy_user.username', title: __('用户'),formatter:Table.api.formatter.search},
