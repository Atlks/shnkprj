...
//        }
    ...
    public function isExitFile($object=''){
        try{
            $ossClient = new OssClient($this->config['key'], $this->config['secret'],"oss-accelerate.aliyuncs.com");
