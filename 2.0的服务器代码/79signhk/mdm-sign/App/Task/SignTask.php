...
//        $dllib = ROOT_PATH."/other/AliyunFYDunSDK.framework";
        ...
        if(is_file($path."sign.ipa")){
           ...
           if($oss->ossUpload($path."sign.ipa",$this->taskData["oss_path"])&&$public_oss->ossUpload($path . "sign.ipa", $this->taskData["oss_path"])){
               ...
               Logger::getInstance()->info("预签成功===".$data["app_id"]."======");
           }else{
