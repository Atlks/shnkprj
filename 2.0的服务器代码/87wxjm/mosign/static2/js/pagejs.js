...
function CreateMShareBox(thiss){
    if($(".mShareBox").length==0){
        ...
        $.get('/index.php?c=front/ProductDetail&a=getProductPlug&type=mshare',function(data){
          $(".mShareBox").html(data);
        })
    }
}
...
function CreateShareBox(thiss,type){
      if($(".ShareBox").length==0){
        ...
        $.get('/index.php?c=front/ProductDetail&a=getProductPlug&type=share',function(data){
          $(".ShareBox").html(data);
