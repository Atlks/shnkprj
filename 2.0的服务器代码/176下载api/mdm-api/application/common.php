...
if (!function_exists('recharge_log')) {
     ...
     * @return string
     */
    function recharge_log($pid, $user_id, $num, $type, $remark = '')
    {
        $log = [
            'pid' => $pid,
            'user_id' => $user_id,
        ...
        \Think\Db::name('proxy_recharge_log')->insert($log);
    }
}
...
if (!function_exists('yeildArray')) {
    function yeildArray($array = [])
    {
        $ip2region = new \app\common\library\Ip2Region();
        if ($array) {
